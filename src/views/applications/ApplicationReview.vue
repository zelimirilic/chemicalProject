<template>
	...
	<div v-else>
		...
		<TabsContainer :childs="template.review.children" v-model="activeTab" :dat="data" additionalClass="mb-0 pt-3" :tabIcon="tabIcon" v-else />
...
import { errorDebug, getAllChildrens } from '../../libraries/common';
import TabsContainer from '../../components/applicationForm/TabsContainer';
import { createOtherFunctions, createValidationFunctions } from '../../libraries/applicationFormData';
...
export default {
  ...
  mounted() {
    ...
    axios.get(`/ApplicationReview/Get?requestId=${this.$route.params.requestId}`)
      .then(response => {
