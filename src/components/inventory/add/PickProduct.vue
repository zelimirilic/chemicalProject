<template>
	<div class="row">
		<div class="col-4 mb-4" v-if="withProductType">
		...
		<div class="col-auto mb-4">
			<DateGroup :text="getTranslation('I00.00017670', 'InventoryDateText') + ':'" v-model="minDate" :minDate="minDate" :maxDate="maxDate" @input="emitProductChanged" :blockDate="true" />
		</div>
...
export default {
  ...
  methods: {
    composeProductName(f) {
      return [f.ArtNo].pushMany([f.ArtName, (f.Department || {}).Name])
